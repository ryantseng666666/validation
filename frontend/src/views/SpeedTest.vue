          ...
          <el-card class="upload-card">
            ...
            <div class="result-area" v-if="result">
              ...
              <div class="result-item">
                ...
                <span class="value">{{ result.referenceId }}</span>
              </div>
              <div class="result-item">
                <span class="label">IP地址：</span>
                <span class="value">{{ result.ipAddress }}</span>
              </div>
              <div class="result-item">
                <span class="label">测量时间：</span>
                <span class="value">{{ result.measurementTime }}</span>
              </div>
              <div class="result-item">
                <span class="label">状态：</span>
                <span class="value" :class="{ 'status-error': result.status === 'ERROR' }">
                  {{ result.status === 'ERROR' ? '识别失败' : '识别成功' }}
                </span>
              </div>
            </div>
          </el-card>
...
const handlePredict = async () => {
  ...
  try {
    ...
    const data = await request.post('/speedtest/predict', {
